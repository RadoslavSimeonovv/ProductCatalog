...
public class DiscontinueProductTests
{
    private static readonly Guid ProductId = Guid.NewGuid();

    private readonly DiscontinueProductCommandHandler _handler;
    ...
    public DiscontinueProductTests()
    {
        ...
        _handler = new DiscontinueProductCommandHandler(_productRepositoryMock, _unitOfWorkMock);
    }
    ...
    public async Task Handle_Should_ReturnFailure_When_Product_Not_Found()
    {
        ...
        // Act
        var result = await _handler.Handle(new DiscontinueProductCommand(ProductId), default);
    ...
    [Fact]
    public async Task Handle_Should_ReturnFailure_When_Product_Is_Already_Discontinued()
    {
        // Arrange
        _productRepositoryMock
            .GetByIdAsync(ProductId, Arg.Any<CancellationToken>())
    ...
    [Fact]
    public async Task Handle_Should_ReturnSuccess_When_Product_Is_Not_Discontinued()
    {
        // Arrange
        _productRepositoryMock
            .GetByIdAsync(ProductId, Arg.Any<CancellationToken>())
