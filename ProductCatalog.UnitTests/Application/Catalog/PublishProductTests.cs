...
public class PublishProductTests
{
    ...
    public PublishProductTests()
    {
        _productRepositoryMock = Substitute.For<IProductRepository>();
        _unitOfWorkMock = Substitute.For<IUnitOfWork>();

        _handler = new PublishProductCommandHandler(_productRepositoryMock, _unitOfWorkMock);
    }
    ...
    public async Task Handle_Should_ReturnFailure_When_Product_Not_Found()
    {
        ...
        // Act
        var result = await _handler.Handle(new PublishProductCommand(ProductId), default);
    ...
    [Fact]
    public async Task Handle_Should_ReturnFailure_When_Product_Is_Already_Active()
    {
        // Arrange
        _productRepositoryMock
            .GetByIdAsync(ProductId, Arg.Any<CancellationToken>())
    ...
    [Fact]
    public async Task Handle_Should_ReturnSuccess_When_Product_Is_Draft()
    {
        // Arrange
        _productRepositoryMock
            .GetByIdAsync(ProductId, Arg.Any<CancellationToken>())
